...
examples.smallExample = function () {
    ...
    this.goal1 = istar.addGoal(200, 88, 'g1');
    istar.embedNode(this.goal1, actor);
    this.goal2 = istar.addGoal(110, 170, 'g2');
    istar.embedNode(this.goal2, actor);
    this.goal3 = istar.addGoal(267, 170, 'g3');
    istar.embedNode(this.goal3, actor);
    this.quality1 = istar.addQuality(510, 250, 'q1');
    istar.embedNode(this.quality1, actor);
    this.quality2 = istar.addQuality(440, 100, 'q2');
    istar.embedNode(this.quality2, actor);
    this.task1 = istar.addTask(150, 270, 't1');
    istar.embedNode(this.task1, actor);
    this.task2 = istar.addTask(315, 260, 't2');
    istar.embedNode(this.task2, actor);
    this.resource1 = istar.addResource(335, 340, 'r1');
    istar.embedNode(this.resource1, actor);
    this.resource2 = istar.addResource(560, 180, 'r2');
    istar.embedNode(this.resource2, actor);
...
examples.justAnActor = function () {
    ...
    this.goal1 = istar.addGoal(200, 88, 'i* models created');
    istar.embedNode(this.goal1, actor);
};

examples.pistarIntro = function () {
    var actor = istar.addActor(119, 49, 'Researcher');
    this.goal1 = istar.addGoal(320, 88, 'i* models created');
    istar.embedNode(this.goal1, actor);
    this.task1 = istar.addTask(290, 170, 'Use piStar');
    istar.embedNode(this.task1, actor);
    this.quality1 = istar.addQuality(190, 65, 'Good Quality');
    istar.embedNode(this.quality1, actor);
